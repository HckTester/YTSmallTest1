...
public class Runner {
	...
	public static void main(String[] args) throws BiffException, IOException {
		...
		XmlTest xT = new XmlTest(xS); // test object C:\Users\lenovo\Desktop\Framework\Smalltest
		File f = new File("C:\\Users\\lenovo\\Desktop\\Framework\\Smalltest\\Dataprovider.xls"); // excel file
